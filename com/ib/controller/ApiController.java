...
public class ApiController implements EWrapper {
	...
	private IConnectionHandler m_connectionHandler;	// MODIFICATION #2 PA (remove final)
	...
	private void internalReqContractDetails( Contract contract, final IInternalHandler processor) {
		...
		m_orderHandlers.put(reqId, new IOrderHandler() { @Override
		public void handle(int errorCode, String errorMsg) { processor.contractDetailsEnd();}
